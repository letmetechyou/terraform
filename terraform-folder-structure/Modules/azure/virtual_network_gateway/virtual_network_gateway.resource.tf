resource "azurerm_virtual_network_gateway" "virtual_network_gateway" {
  ...
  dynamic "ip_configuration" {
    ...
    content {
      ...
      subnet_id            = coalesce(try(ip_configuration.value.subnet_id, null), try(var.subnet_output["${ip_configuration.value.subnet_name}"].id, null))
  ...
  tags                       = each.value.tags #module.resource_group.resource_group_output.tags
